...
//streamingMicRecognizeをオーバーロード
function streamingMicRecognize(encoding, sampleRateHertz
  , languageCode, buffer) {
  // [START speech_streaming_mic_recognize]
  ...
  const readStream = new require('stream').PatThrough();
  readStream.end( buffer );
  readStream.pipe( recognizeStream );
}
//コマンドラインからの操作機能を追加する箇所のためコメントアウト
//
// require(`yargs`)
//   .demand(1)
//   .command(
